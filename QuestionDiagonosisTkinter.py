...
class MainForm(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Intelligence Healthcare Chatbot", bg="orange", width="300", height="2", font=("Calibri", 16))
        self.lblMsg.pack()
        self.btnLogin=Button(self, text="Login", height="2", width="300", command = self.lblLogin_Click)
        self.btnLogin.pack()
        self.btnRegister=Button(self, text="Register",bg="green",  height="2", width="300", command = self.btnRegister_Click)
        self.btnRegister.pack()
        self.lblTeam=Label(self, text="Made by:", bg="lightblue", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam.pack()
        self.lblTeam3=Label(self, text="Yash Sharma", bg="lightblue", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam3.pack()
        self.lblTeam3 = Label(self, text="OUI118BCS017 , B.tech CSE 6th Semester", bg="lightblue",width="250", height="1", font=("Calibri", 13))
        self.lblTeam3.pack()
...
class Login(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Please enter details below to login",bg="lightblue")
        self.lblMsg.pack()
        ...
        self.btnLogin=Button(self, text="Login",bg="skyblue", width=10, height=1, command=self.btnLogin_Click)
        self.btnLogin.pack()
