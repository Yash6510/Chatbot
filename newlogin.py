...
#    register_screen = Toplevel(main_screen)
    ...
    Label(register_screen, text="Please enter the details below", bg="lightblue").pack()
    ...
    password_entry.pack()
    Label(register_screen, text="").pack()
    Button(register_screen, text="Register", width=10, height=1, bg="skyblue", command=register_user).pack()
...
def main_account_screen(frmmain):
    ...
    Label(main_screen,text="Select Your Choice", bg="lightblue", width="300", height="2", font=("Calibri", 13)).pack()
